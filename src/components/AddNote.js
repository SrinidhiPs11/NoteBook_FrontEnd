...
const AddNote = () => {
    ...
    return (
        ...
        <div className='container mx-auto px-4 py-8'>
            <h1 className='text-3xl font-bold mb-6 mt-10'>Write a Note</h1>
            <form className="space-y-6">
                <div>
                    <label htmlFor="title" className="block text-sm font-medium text-gray-700">Title</label>
                    <input type="text" className="mt-1 p-2 border block w-full rounded-md border-gray-300 shadow-sm" id="title" name="title" value={note.title} onChange={onChange}/>
                </div>
                <div>
                    <label htmlFor="description" className="block text-sm font-medium text-gray-700">Description</label>
                    <textarea className="mt-1 p-2 border block w-full rounded-md border-gray-300 shadow-sm focus:border-black focus:ring focus:ring-black focus:ring-opacity-50" id="description" name="description" value={note.description} rows="3" onChange={onChange}></textarea>                </div>
                <div>
